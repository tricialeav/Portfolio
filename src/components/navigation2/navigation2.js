                        ...
                        <div>
                            <div id='navLinks'>
                                ...
                                <Link
                                    ...
                                    offset={-30}
                                    duration={700}
                                    onClick={e => this.toggleNav(e)}>My Work</Link>
                                {/* <Link
                                    activeClass="active"
                                    to="photography"
                                    spy={true}
                                ...
                                <div>
                                    <a href='https://www.linkedin.com/in/tricia-leavitt/' target='_blank' rel="noopener noreferrer"><i className="fab fa-linkedin"></i></a>
                                    <a href='https://github.com/tricialeav' target='_blank' rel="noopener noreferrer"><i className="fab fa-github-square"></i></a>
                                    <a href='https://www.instagram.com/tricialeav/' target='_blank' rel="noopener noreferrer"><i className="fab fa-instagram"></i></a>
